...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!-- CONTENT WRAPPER -->
    <div class="container mt-4 mb-4 advisorBoardUpdate" id="advisorBoardUpdate">
      <div class="section-title text-center">
        <h3>${advisorBoard.advisorNickname} 게시판 글 수정</h3>
      </div>
      <div class="ec-register-wrapper">
        <div class="ec-register-container">
          <div class="ec-register-form">
            <form id="advisorBoardForm" action="/advisor/sub/board/${advisorBoard.advisorNickname}/update" method="post">
              <input type="hidden" name="advisorBoardId" value="${advisorBoard.advisorBoardId}">
              <span class="ec-register-wrap ec-register-half mb-4">
                <label>작성자</label>
                <span class="spanUserName ms-5">${advisorBoard.userName}</span>
              </span>
              <span class="ec-register-wrap">
                <label>제 목</label>
                <input type="text" name="title" value="${advisorBoard.title}" />
              </span>
              <span class="ec-register-wrap">
                <label>내 용</label>
                <textarea name="content" rows="10"  id="">${advisorBoard.content}</textarea>
              </span>
              <div class="d-flex justify-content-center w-100">
                <span class="ec-register-wrap ec-register-btn">
                  <button id="historyBack" class="btn btn-secondary" type="button">취 소</button>
                </span>
                <span class="ec-register-wrap ec-register-btn">
